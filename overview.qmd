...
## II. [Mining for Simple Features and Sentiment](simple-features.qmd)
...
## III. [Mining for Complex Features and Correlation](complex-features.qmd)

-   Distinctive Words: Measuring Nuance with Tf-Idf
-   Relationships and Interactions among Words: N-grams, Phrases, and Correlation

## IV. [Text Clustering and Classification](classification.qmd)
