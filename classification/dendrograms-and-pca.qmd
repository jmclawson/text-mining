...
subtitle: "Using Hierarchical Clusters and Principal Components Analysis"
categories: 
  - high-dimensionality
  - visualization
order: 4
df-print: default
description: "Finding hierarchical clusters, performing principal components analysis, and creating visualizations, oh my!"
freeze: false
draft: true
---
...
```{r}
library(tidyverse)
readRDS("../appendix/data/blake_songs.rds")
readRDS("../appendix/data/blake_lines.rds")
readRDS("../appendix/data/blake_words.rds")
readRDS("../appendix/data/read_blake.rds")
```
