...
dubtitle: "Calculating Distance between Texts"
categories: 
  - high-dimensionality
  - distance
order: 2
df-print: default
description: "Measuring distances between texts."
freeze: false
---

## Getting Started

First, load up packages, data, and helper functions. For this unit, we'll be using the `tidytext` package, which adds some standard text mining techniques to the `tidyverse` set of packages.
